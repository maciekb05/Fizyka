...
\begin{document}
	...
	\begin{itemize}
		\item W pierwszym kroku przy pomocy markera narysowano na płtyce znak trzy krzyżyki w równej odległosci od siebie.
		W ten sposób, aby po jednej stronie przeźroczystej płytki
		płytki znalazło się jedno ramię krzyżyka.
		\item 
			Przy użyciu śruby mikrometrycznie dokonano pomiaru grubości płtki w 
		...
		górnego ramienia pierwszego krzyżka.  Odczytano pomiar z mikroskopu.
		 w  Następnie zmieniono położenie, uzyskano ostry obraz dolnego ramienia i odczyto jego pomiar. 
		\item Podobnie jak poprzednio,  
	\end{itemize}
